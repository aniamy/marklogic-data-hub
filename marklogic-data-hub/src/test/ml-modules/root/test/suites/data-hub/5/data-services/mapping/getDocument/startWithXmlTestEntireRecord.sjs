...
import xmlToJson from "/data-hub/5/data-services/mapping/xmlToJsonForMapping.mjs";

const assertions = [];

const result = utils.invokeService(utils.STEP_NAME2, '/content/sampleCustomerDoc.xml');
