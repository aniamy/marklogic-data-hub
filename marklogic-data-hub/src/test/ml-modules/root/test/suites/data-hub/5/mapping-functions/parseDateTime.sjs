...
[
  ...
  test.assertTrue(coreSjs.parseDateTime("06/01/2014-18:13:50", "DD/MM/YYYY-hh:mm:ss").startsWith(expectedDateTime)),
  test.assertTrue(coreSjs.parseDateTime("06/01/2014 18:13:50", "DD/MM/YYYY hh:mm:ss").startsWith(expectedDateTime)),
  test.assertTrue(coreSjs.parseDateTime("20140106T181350", "YYYYMMDDThhmmss").startsWith(expectedDateTime)),
  test.assertTrue(coreSjs.parseDateTime("2014/01/06-18:13:50", "YYYY/MM/DD-hh:mm:ss").startsWith(expectedDateTime)),
  test.assertTrue(coreSjs.parseDateTime("2014/01/06 18:13:50", "YYYY/MM/DD hh:mm:ss").startsWith(expectedDateTime)),
  test.assertTrue(coreSjs.parseDateTime("2014.01.06 AD at 18:13:50", "yyyy.MM.dd G 'at' HH:mm:ss").startsWith(expectedDateTime)),

  test.assertEqual(null, coreSjs.parseDateTime(null, "DD/MM/YYYY-hh:mm:ss")),
  test.assertEqual(null, coreSjs.parseDateTime("", "DD/MM/YYYY-hh:mm:ss")),
  test.assertEqual(null, coreSjs.parseDateTime(" ", "DD/MM/YYYY-hh:mm:ss"))
];
