...
const ResultsTabularView = (props) => {
  ...
  const tableHeaders = searchOptions.entityTypeIds ? searchOptions.entityTypeIds.length > 1 ? DEFAULT_ALL_ENTITIES_HEADER : updatedTableHeader() : DEFAULT_ALL_ENTITIES_HEADER;
